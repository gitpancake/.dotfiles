...
- `claude/commands/*.md` are **slash commands** typed by the user. Available: `/sync-from-linear`, `/sync-to-linear`, `/scope`, `/rescope`, `/read-ticket`, `/ship`, `/address-feedback`, `/linear-review`, `/simplify`, `/retrospective`.
